      ...
      <div className="max-w-container mx-auto px-6 sm:px-10 lg:px-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            {/* Dijital Kanallar (LinkedIn, GitHub, Play Store) with Official Logos */}
            <motion.div
              initial={{ opacity: 0, y: 14 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <a
                ...
                className="p-3.5 sm:p-4 bg-white border border-[#DED8CC] hover:border-[#0A66C2]/40 rounded-[8px] flex flex-col items-center justify-center text-center hover:-translate-y-[2px] transition-all duration-200 group shadow-[0_2px_8px_rgba(32,32,29,0.02)]"
              >
                <div className="w-8 h-8 rounded-[6px] bg-[#0A66C2]/8 flex items-center justify-center mb-2 text-[#0A66C2] group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#0A66C2">
                    <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"/>
                  </svg>
                </div>
                <div className="text-[12px] sm:text-[13px] font-bold text-[#171717] group-hover:text-[#0A66C2] transition-colors leading-tight">LinkedIn</div>
                <div className="text-[10px] sm:text-[11px] text-[#625D55] mt-0.5">Profil</div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3.5 sm:p-4 bg-white border border-[#DED8CC] hover:border-[#181717]/40 rounded-[8px] flex flex-col items-center justify-center text-center hover:-translate-y-[2px] transition-all duration-200 group shadow-[0_2px_8px_rgba(32,32,29,0.02)]"
              >
                <div className="w-8 h-8 rounded-[6px] bg-[#181717]/6 flex items-center justify-center mb-2 text-[#181717] group-hover:scale-110 transition-transform duration-200">
                ...
                <div className="text-[12px] sm:text-[13px] font-bold text-[#171717] group-hover:text-[#181717] transition-colors leading-tight">GitHub</div>
                <div className="text-[10px] sm:text-[11px] text-[#625D55] mt-0.5">Projeler</div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3.5 sm:p-4 bg-white border border-[#DED8CC] hover:border-[#00D7FF]/40 rounded-[8px] flex flex-col items-center justify-center text-center hover:-translate-y-[2px] transition-all duration-200 group shadow-[0_2px_8px_rgba(32,32,29,0.02)]"
              >
                <div className="w-8 h-8 rounded-[6px] bg-[#4285F4]/8 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform duration-200">
                ...
                <div className="text-[12px] sm:text-[13px] font-bold text-[#171717] group-hover:text-[#4285F4] transition-colors leading-tight">Google Play</div>
                <div className="text-[10px] sm:text-[11px] text-[#625D55] mt-0.5">5K+ İndirme</div>
              </a>
            </motion.div>
